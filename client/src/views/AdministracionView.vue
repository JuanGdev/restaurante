      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col cols="'6">
                <v-text-field v-model="nueva_mesa.mesa_capacidad" label="Capacidad">
                </v-text-field>
              </v-col>
              <v-col cols="'6">
                <v-text-field v-model="nueva_mesa.mesa_estatus" label="Estatus (Libre/Ocupada)">
                </v-text-field>
              </v-col>
            </v-row>
          </v-container>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              ...
              <v-col cols="'6">
                <v-text-field v-model="nuevo_mesero.mes_ap_pat" label="Apellido paterno">
                </v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="'6">
                <v-text-field v-model="nuevo_mesero.mes_ap_mat" label="Apellido materno">
                </v-text-field>
              </v-col>
            </v-row>
          </v-container>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-container>
            <v-row>
              <v-col cols="'6">
                <v-text-field v-model="nuevo_producto.pro_nombre" label="Nombre">
                </v-text-field>
              </v-col>
              <v-col cols="'6">
                <v-text-field v-model="nuevo_producto.pro_desc" label="Descripción">
                </v-text-field>
              </v-col>
            </v-row>
            <v-row>
              ...
              <v-col cols="'6">
                <v-text-field v-model="nuevo_producto.pro_cob" label="comida/bebida">
                </v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="'6">
                <v-text-field v-model="nuevo_producto.pro_categoria" label="Categoría (garnacha, caldo, carne, agua, licor, refresco)">
                </v-text-field>
              </v-col>
            </v-row>
          </v-container>
